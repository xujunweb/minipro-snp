...
module.exports = function() {
  ...
  (function(webim) {
      ...
      switch (msg.sess.type()) {
        case SESSION_TYPE.C2C:
          msgInfo = {
            ...
            'From_AccountNick': msg.fromAccountNick,
            'From_AccountHeadurl': msg.fromAccountHeadurl,
    ...
    var Msg = function(sess, isSend, seq, random, time, fromAccount, subType, fromAccountNick, fromAccountHeadurl) {
      ...
      try{
        this.fromAccountNick = fromAccountNick ? fromAccountNick : wx.getStorageSync('IMUserInfoMap')[fromAccount].Tag_Profile_IM_Nick || '未知用户';
        this.fromAccountHeadurl = fromAccountHeadurl ? fromAccountHeadurl : wx.getStorageSync('IMUserInfoMap')[fromAccount].Tag_Profile_IM_Image || null;
      }catch(err){
        console.log(err)
        this.fromAccountNick = '未知用户'
        this.fromAccountHeadurl = null
      }
